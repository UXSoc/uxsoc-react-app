    ...
    render() {
        return (
            <div className="sections">
                ...
                <h5>Books</h5>
                <div className="line1"><img src={grayLine} alt="grayLine"/></div>
                </div>
                <div className="articlesSection">
                <h5>Articles</h5>
                <div className="line2"><img src={blackLine} alt="blackLine"/></div>
                </div>
                <div className="podcastsSection">
                <h5>Podcasts</h5>
                <div className="line3"><img src={grayLine} alt="grayLine"/></div>
                </div>
            </div>
         );
    }
